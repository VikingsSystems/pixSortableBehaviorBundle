 ...
 */
class ObjectPositionExtension extends \Twig\Extension\AbstractExtension
{
    ...
    {
        return array(
            new \Twig\TwigFunction('currentObjectPosition', array($this, 'currentPosition')),
            new \Twig\TwigFunction('lastPosition', array($this, 'lastPosition'))
        );
    }
